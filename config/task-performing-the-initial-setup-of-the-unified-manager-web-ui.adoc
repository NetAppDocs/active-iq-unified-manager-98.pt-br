...
. Nos sistemas Red Hat e CentOS, é possível alterar a senha do usuário umadmin da cadeia de carateres padrão "admin" para uma cadeia de carateres personalizada.
