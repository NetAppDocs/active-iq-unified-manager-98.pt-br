...
Você pode acessar a IU da Web para executar a configuração inicial do Gerenciador Unificado, conforme descrito em _Configurando o Active IQ Unified Manager_.
