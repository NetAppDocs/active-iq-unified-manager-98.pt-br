...
sidebar: sidebar 
keywords:  
summary: Você pode atualizar o dispositivo virtual do Unified Manager das versões 9,6 e 9,7 para 9,8. 
---
...
[role="lead"]
Você pode atualizar o dispositivo virtual do Unified Manager das versões 9,6 e 9,7 para 9,8.
