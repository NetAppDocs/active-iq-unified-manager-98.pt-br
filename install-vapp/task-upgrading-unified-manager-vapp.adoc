...
sidebar: sidebar 
keywords:  
summary: Você pode atualizar para o Unified Manager 9,8 somente a partir de instâncias de 9,6 ou 9,7. 
---
...
[role="lead"]
Você pode atualizar para o Unified Manager 9,8 somente a partir de instâncias de 9,6 ou 9,7.
